...
class CheckLP (a: Array[Array[Int]], b: Array[Int], c: Array[Int]) {
	...
	def isPrimalFeasible (x: Array[Int]): Boolean = {
	...
	def isDualFeasible (y: Array[Int]): Boolean = {
	...
	def isOptimal (x: Array[Int], y: Array[Int], f: Double): Boolean = {
		var cx = 0
	...
	def isCorrect (x: Array[Int], y: Array[Int], f: Double): Boolean = {
